#!/bin/bash
# THIS FILE TAKES A SNAPSHOT OF ALL .rs AND .toml FILES IN THIS REPO AND PLACES IT IN A FILE CALLED deep.rs AT PROJECT ROOT. RUN `bash deep.sh` AT PROJECT ROOT IF YOU HAVE A USE CASE
